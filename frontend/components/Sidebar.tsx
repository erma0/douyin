...
import { 
  Film, User, Heart, Star, Music, Hash, Layers, Search, Github, Settings, Terminal, Download
} from 'lucide-react';
    ...
    <div className="w-64 bg-slate-900 text-white flex flex-col h-full shadow-2xl relative z-50">
      ...
      <div className="p-4 bg-slate-950/30 border-t border-slate-800 space-y-1">
         ...
         <button 
           ...
           className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 group ${
             showLogs ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800'
           }`}
         >
