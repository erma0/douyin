...
import { CheckCircle, XCircle, Info, X, AlertTriangle, Loader2, Clock } from 'lucide-react';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col gap-2 w-full max-w-sm pointer-events-none">
      {toasts.map((t) => (
        <div 
          key={t.id}
          className={`pointer-events-auto rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border animate-in slide-in-from-bottom-2 fade-in duration-300 overflow-hidden ${
